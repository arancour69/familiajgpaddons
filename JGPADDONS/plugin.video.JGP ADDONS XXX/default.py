...
Base = 'http://jgpaddonsxxx.blogspot.com.es/p/color-fuchsiacolorcolor-fuchsia-jgp.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.JGP ADDONS XXX') #    modificar("el nombre de tu addons")
